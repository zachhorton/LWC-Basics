...
export default class Lookup extends LightningElement {
    ...
    handleRemoveSelectedItem(event) {
        if (this.disableChange == true) return; // Don't process removal is disableChange is true
    ...
    // Must have api decoration to be called from parent classes
    ...
    // added for ability to set default value
    @api handleDefaultResult(existingSelection) {
        console.log(existingSelection);
        this.curSelection = [];
        this.curSelection.push(existingSelection);
